    ...
    public class SolutionRevisedOnDayThird {
        ...
        public int minCostII(int[][] costs) {
            ...
            for (int houseIndex = 1; houseIndex < numHouses; houseIndex++) {
                ...
                int[] currentRows = costs[houseIndex].clone();

                for (int curColor = 1; curColor < numColors; curColor++) {

                    if (previousRows[curColor] == min1) {
                        currentRows[curColor] += min2;
                    } else {
                        currentRows[curColor] += min1;
                    }
                }
        ...
        public int minCostII(int[][] costs) {
            ...
            for (int houseIndex = 1; houseIndex < numHouses; houseIndex++) {
                ...
                for (int color = 0; color < numColors; color++) {
                    ...
                    if (previousRows[color] == min1) {
                        currentRows[color] += min2;
                    } else {
                        currentRows[color] += min1;
                    }
                }
