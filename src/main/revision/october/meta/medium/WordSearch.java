 ...
 * 79. Word Search Medium Topics Companies Given an m x n grid of characters
 * board and a string word, return true if
 ...
 * [["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]], word = "SEE" Output:
 * true Example
 * 3: Input: board = [["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]],
 * word = "ABCB" Output: false
 * <p>
 * Constraints: m == board.length n = board[i].length 1 <= m, n <= 6 1 <=
 * word.length <= 15 board and word consists of
...
public class WordSearch {
	 ...
	 * Where m is the number of cells in the board and n is the length of the w o r
	 * d word.
	 */
