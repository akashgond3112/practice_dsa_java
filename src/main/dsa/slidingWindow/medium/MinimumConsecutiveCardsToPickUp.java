 ...
 *          matching pair of cards with value 3. Note that picking up the cards
 *          [4,2,3,4] is also optimal.
 *          Example 2:
 *          <p>
 *          Input: cards = [1,0,5,3]
 *          Output: -1
...
public class MinimumConsecutiveCardsToPickUp {
    ...
    public static void main(String[] args) {
        ...
        nums1 = new int[] { 95, 11, 8, 65, 5, 86, 30, 27, 30, 73, 15, 91, 30, 7, 37, 26, 55, 76, 60, 43, 36, 85, 47, 96,
                6 };
        result = minimumCardPickup(nums1);
        System.out.println(result); // Test 2
    }
