 ...
 * new MinStack(); obj.push(val);
 * obj.pop(); int param_3 = obj.top(); int param_4 = obj.getMin();
 * 155. Min Stack Medium Topics Companies Hint Design a stack that supports
 * push, pop, top, and retrieving the minimum
 * element in constant time.
 *
 * Implement the MinStack class:
 *
 * MinStack() initializes the stack object. void push(int val) pushes the
 * element val onto the stack. void pop() removes
 * the element on the top of the stack. int top() gets the top element of the
 * stack. int getMin() retrieves the minimum
 ...
 * called on non-empty stacks. At most 3 *
